...
service = ChromeService(
    ...
    # window
    executable_path=str(currentFolderPath) + \
...
try:
    ...
    try:
        lightboxElement = driver.find_element(
            By.XPATH, '//*[@id="scrollview"]/following-sibling::div/div/div/div[1]/div/div[2]/div/div/div/div/div[2]/div/div/div[3]/button[2]')
